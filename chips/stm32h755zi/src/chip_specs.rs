...
//! STM32H755 specifications

use stm32h7xx::chip_specific::clock_constants::{PllConstants, SystemClockConstants};
use stm32h7xx::chip_specific::flash::{FlashChipSpecific, FlashLatency16};

pub enum Stm32h755Specs {}

impl PllConstants for Stm32h755Specs {
    const MIN_FREQ_MHZ: usize = 13;
}

impl SystemClockConstants for Stm32h755Specs {
    const APB1_FREQUENCY_LIMIT_MHZ: usize = 45;
    const SYS_CLOCK_FREQUENCY_LIMIT_MHZ: usize = 168;
}

impl FlashChipSpecific for Stm32h755Specs {
