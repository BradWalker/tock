...
const DMA1_BASE: StaticRef<DmaRegisters> =
    unsafe { StaticRef::new(0x4002_0000 as *const DmaRegisters) };
...
impl<'a> Dma1<'a> {
    pub const fn new(clocks: &'a dyn Stm32h7Clocks) -> Self {
        Self {
            registers: DMA1_BASE,
...
const DMA2_BASE: StaticRef<DmaRegisters> =
    unsafe { StaticRef::new(0x4002_0400 as *const DmaRegisters) };
