...
use crate::clocks::{phclk, Stm32h7Clocks};
...
const GPIOH_BASE: StaticRef<GpioRegisters> =
    unsafe { StaticRef::new(0x5802_1C00 as *const GpioRegisters) };

const GPIOG_BASE: StaticRef<GpioRegisters> =
    unsafe { StaticRef::new(0x5802_1800 as *const GpioRegisters) };

const GPIOF_BASE: StaticRef<GpioRegisters> =
    unsafe { StaticRef::new(0x5802_1400 as *const GpioRegisters) };

const GPIOE_BASE: StaticRef<GpioRegisters> =
    unsafe { StaticRef::new(0x5802_1000 as *const GpioRegisters) };

const GPIOD_BASE: StaticRef<GpioRegisters> =
    unsafe { StaticRef::new(0x5802_0C00 as *const GpioRegisters) };

const GPIOC_BASE: StaticRef<GpioRegisters> =
    unsafe { StaticRef::new(0x5802_0800 as *const GpioRegisters) };

const GPIOB_BASE: StaticRef<GpioRegisters> =
    unsafe { StaticRef::new(0x5802_0400 as *const GpioRegisters) };

const GPIOA_BASE: StaticRef<GpioRegisters> =
    unsafe { StaticRef::new(0x5802_0000 as *const GpioRegisters) };
...
impl<'a> GpioPorts<'a> {
    pub fn new(clocks: &'a dyn Stm32h7Clocks, exti: &'a exti::Exti<'a>) -> Self {
        Self {
            ports: [
                Port {
